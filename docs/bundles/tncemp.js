...
var getMapData = function () {
  var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6(scen) {
    var data_url, resp, jsonData, lookup, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, entry;

    return _regenerator2.default.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            data_url = API_SERVER + DATA_VIEW + '?select=tmc,scenario,' + app.selected_metric + ',' + app.selected_bwidth + '&tod=eq.' + app.selected_timep;
            _context6.next = 3;
            return fetch(data_url);
          ...
          case 6:
            ...
            for (_iterator4 = (0, _getIterator3.default)(jsonData); !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
              entry = _step4.value;
          ...
          case 28:
            return _context6.abrupt('return', lookup);
  ...
  return function getMapData(_x4) {
...
var drawMapFeatures = function () {
  var _ref7 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee7() {
    ...
    var cleanFeatures, sel_metric, map_metric, bwidth_metric, _iteratorNormalCompletion5, _didIteratorError5, _iteratorError5, _iterator5, _step5, feat, color_func, sel_colorvals2, bp, x, numticks, histogram, mode, custom_bps, i, bw_widths, _iteratorNormalCompletion6, _didIteratorError6, _iteratorError6, _iterator6, _step6, _feat, _iteratorNormalCompletion7, _didIteratorError7, _iteratorError7, _iterator7, _step7, _i;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            _context7.next = 8;
            return getMapData(app.selected_scenario);

          case 8:
            base_lookup = _context7.sent;
          ...
          case 13:
            ...
            _context7.prev = 20;
            for (_iterator5 = (0, _getIterator3.default)(cleanFeatures); !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
              feat = _step5.value;
          ...
          case 86:
            ...
            _context7.prev = 90;
            for (_iterator7 = (0, _getIterator3.default)(sel_colorvals2); !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
              _i = _step7.value;
          ...
          case 94:
            _context7.prev = 94;
            _context7.t2 = _context7['catch'](90);
    ...
    }, _callee7, this, [[3, 115], [20, 24, 28, 36], [29,, 31, 35], [49, 74, 78, 86], [79,, 81, 85], [90, 94, 98, 106], [99,, 101, 105]]);
  }));
...
var EXCLUDE_COLS = ['tmc', 'geometry', 'geom', 'gid', 'street', 'direction', 'intersec', 'tod', 'modifiedtmc', 'scenario'];
/*
...
*/
var FRAC_COLS = ['speed', 'time', 'vol', 'vmt', 'vhd', 'vht', 'pti80', 'pti80_vmt', 'obs_speed', 'obs_time', 'obs_vmt', 'obs_vhd', 'obs_vht', 'obs_pti80', 'obs_pti80_vmt'];
...
var CUSTOM_BP_DICT = {
  ...
  'capacity': { 'base': [1500, 3000, 4500, 6000], 'diff': [-500, -1, 1, 500], 'pctdiff': [-5, -1, 1, 5] }
};
...
var init_selected_metric = 'delay_per_mile';
var metric_options_all = void 0,
    metric_options_daily = void 0;
var daily_metric_list = ['vol', 'speed', 'vmt', 'vht', 'vhd', 'obs_vhd', 'obs_vht', 'inrix_speed', 'tnc_pudo', 'pudo_per_mile', 'capacity', 'lanes'];
...
infoPanel.update = function (geo) {
  ...
  if (geo) {
    this._div.innerHTML = '<b>TMC ID: </b>' + (geo.tmc + '<br/>') + '<b>STREET: </b>' + (geo.street + '<br/>') + '<b>DIRECTION: </b>' + (geo.direction + '<br/>') + '<b>INTERSECTION: </b>' + (geo.intersec + '<br/><hr>') + ('<b>' + app.selected_metric.toUpperCase() + '</b>') + (app.pct_check ? '<b> % Diff: </b>' : '<b>: </b>') + ('' + metric_val) + (app.pct_check && app.comp_check && metric_val !== null ? '%' : '') + (app.bwidth_check ? '<br/><b>' + app.selected_bwidth.toUpperCase() + '</b>' + '<b>: </b>' + bwmetric_val : '');
  }
...
function updateDistChart(bins) {
  ...
  try {
    for (var _iterator8 = (0, _getIterator3.default)(bins), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
      var b = _step8.value;
...
function buildChartHtmlFromCmpData() {
  ...
  if (json) {
    ...
    try {
      for (var _iterator9 = (0, _getIterator3.default)(json), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
...
function updateOptionsData(colname) {
  ...
  fetch(API_SERVER + DATA_VIEW + '?select=' + colname + '&' + colname + '=neq.null').then(function (resp) {
    ...
    try {
      for (var _iterator11 = (0, _getIterator3.default)(sellist), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
...
function getMetricOptions() {
  ...
  fetch(API_SERVER + DATA_VIEW + '?limit=1').then(function (resp) {
    ...
    try {
      for (var _iterator12 = (0, _getIterator3.default)(sellist), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
        var _entry2 = _step12.value;
    ...
    try {
      for (var _iterator13 = (0, _getIterator3.default)(daily_metric_list), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
        var _entry3 = _step13.value;

        metric_options_daily.push({ text: _entry3, value: _entry3 });
      }
    } catch (err) {
    ...
    try {
      for (var _iterator14 = (0, _getIterator3.default)(bwidth_metric_list), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
        var _entry4 = _step14.value;

        app.bwidth_options.push({ text: _entry4, value: _entry4 });
      }
    } catch (err) {
...
var app = new Vue({
  ...
  data: {
    ...
    { text: 'Cream-Purple', value: ['#ffffcc', '#3f324f'] }, { text: 'Purple-Cream', value: ['#3f324f', '#ffffcc'] }, { text: 'GnYlRd', value: ['Green', 'Yellow', 'Red'] }, { text: 'RdYlGn', value: ['Red', 'Yellow', 'Green'] }, { text: 'YlOrRd', value: 'YlOrRd' }, { text: 'Yellow-Blue', value: ['#fafa6e', '#2A4858'] }, { text: 'YlRdBl', value: ['Yellow', 'Red', 'Black'] }, { text: 'Spectral', value: 'Spectral' }, { text: 'YlGn', value: 'YlGn' }],
    modeMap: {
      '#ffffcc,#663399': 'lch',
      '#ebbe5e,#3f324f': 'hsl',
      '#ffffcc,#3f324f': 'hsl',
