      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            console.log('3 !!!');
            _context.next = 10;
            return fetch(API_SERVER + DATA_VIEW).then(function (resp) {
              return resp.json();
            });

          case 10:
            mapdata_cache = _context.sent;
...
var getMapData = function () {
  var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3() {
    var jsonData, data_url, resp, lookup, fac_lookup, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, entry, key, voldiff_list, voldiff_tot, _getDiffArray, _getDiffArray2, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, v, tmp_list, tot, _getDiffArray3, _getDiffArray4, diff, i, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, c, _iteratorNormalCompletion5, _didIteratorError5, _iteratorError5, _iterator5, _step5, _v;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            data_url = API_SERVER + DATA_VIEW + '?select=*&tod=eq.' + app.selected_timep;
            _context3.next = 5;
          ...
          case 12:
            jsonData = mapdata_cache.filter(function (row) {
              return row.tod == app.selected_timep;
            });
          ...
          case 20:
            ...
            fac_lookup[key] = {};
            voldiff_list = void 0, voldiff_tot = void 0;
            _getDiffArray = getDiffArray(entry, 'vol');
            _getDiffArray2 = (0, _slicedToArray3.default)(_getDiffArray, 2);
            voldiff_list = _getDiffArray2[0];
            voldiff_tot = _getDiffArray2[1];
            _iteratorNormalCompletion3 = true;
            _didIteratorError3 = false;
            _iteratorError3 = undefined;
            _context3.prev = 32;

            for (_iterator3 = (0, _getIterator3.default)(VIZ_LIST); !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
              v = _step3.value;
              tmp_list = void 0, tot = void 0;
              _getDiffArray3 = getDiffArray(entry, v);
              _getDiffArray4 = (0, _slicedToArray3.default)(_getDiffArray3, 2);
              tmp_list = _getDiffArray4[0];
              tot = _getDiffArray4[1];

              entry['mod_' + v + '_2010'] = entry['emp_' + v + '_2010'];
              entry['mod_' + v + '_' + SCN_LIST_SHORT[SCN_LIST_SHORT.length - 1]] = entry['emp_' + v + '_2016'];
              diff = entry['emp_' + v + '_2016'] - entry['emp_' + v + '_2010'];

              for (i = 1; i < SCN_LIST_SHORT.length - 1; i++) {
                if (tot < 0.01) {
          ...
          case 48:
            ...
            _context3.prev = 52;
            _iterator4 = (0, _getIterator3.default)(SCN_LIST_SHORT);
          ...
          case 54:
            ...
            _context3.prev = 60;
            for (_iterator5 = (0, _getIterator3.default)(VIZ_LIST); !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
              _v = _step5.value;

              fac_lookup[key][c][_v] = Math.round(entry['mod_' + _v + '_' + c] * 100) / 100;
            }
            _context3.next = 68;
            break;
    ...
    }, _callee3, this, [[18, 98, 102, 110], [32, 36, 40, 48], [41,, 43, 47], [52, 81, 85, 93], [60, 64, 68, 76], [69,, 71, 75], [86,, 88, 92], [103,, 105, 109]]);
  }));
...
var drawMapFeatures = function () {
  var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4() {
    ...
    var cleanFeatures, sel_metric, base_metric, _ref5, _ref6, map_metric, _iteratorNormalCompletion6, _didIteratorError6, _iteratorError6, _iterator6, _step6, feat, feat_entry, tmp, _iteratorNormalCompletion7, _didIteratorError7, _iteratorError7, _iterator7, _step7, s, d, color_func, sel_colorvals2, bp, mode, custom_bps, i, _iteratorNormalCompletion8, _didIteratorError8, _iteratorError8, _iterator8, _step8, _i;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            ...
            base_metric = 'mod_' + sel_metric + '_' + SCNTXT_MAP[app.sliderValue[0]];
          ...
          case 10:
            ...
            _context4.prev = 19;
            _iterator6 = (0, _getIterator3.default)(cleanFeatures);
          ...
          case 21:
            ...
            feat_entry = base_lookup[feat.tmc];
            ...
            for (_iterator7 = (0, _getIterator3.default)(app.checkedScn); !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
              s = _step7.value;
              d = FACTXT_MAP_CHK[s];
          ...
          case 70:
            ...
            _context4.prev = 79;
            for (_iterator8 = (0, _getIterator3.default)(sel_colorvals2); !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
              _i = _step8.value;
          ...
          case 83:
            _context4.prev = 83;
            _context4.t2 = _context4['catch'](79);
          ...
          case 95:
            ...
            mapLegend.onAdd = function (map) {
              ...
              var legHTML = getLegHTML(sel_colorvals, sel_colors, sel_binsflag, app.pct_check && app.comp_check ? '%' : '', app.selected_metric == 'speed' ? false : true);
    ...
    }, _callee4, this, [[6, 111], [19, 57, 61, 69], [31, 35, 39, 47], [40,, 42, 46], [62,, 64, 68], [79, 83, 87, 95], [88,, 90, 94]]);
  }));
...
var selectionChanged = function () {
  var _ref7 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(thing) {
    var tmp, _iteratorNormalCompletion12, _didIteratorError12, _iteratorError12, _iterator12, _step12, k, selfeat;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 8:
            ...
            for (_iterator12 = (0, _getIterator3.default)(app.checkedScn); !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
              k = _step12.value;
...
var FACTXT_MAP = { 'netchg': 'Network',
  ...
  'empchg': 'Employment',
  'pudochg': 'TNC' };
var FACTXT_MAP_CHK = { 'net': ['2010', 'netchg'],
  'pop': ['netchg', 'popchg'],
  'emp': ['popchg', 'empchg'],
  'tnc': ['empchg', 'pudochg'] };

var VIZ_LIST = ['vhd', 'vmt', 'speed'];
var VIZ_INFO = {
  vhd: {
...
var metric_sum_map = { Daily: { '2010': { vmt: 8105225.64, vht: 371147.07, speed: 21.84, vhd: 154991.55, pti80: 2.24 },
...
function getDiffArray(entry, metric) {
  ...
  for (var i = 1; i < SCN_LIST_SHORT.length; i++) {
    var val = Math.round(entry['mod_' + metric + '_' + SCN_LIST_SHORT[i]] * 100) / 100;
    var preval = Math.round(entry['mod_' + metric + '_' + SCN_LIST_SHORT[i - 1]] * 100) / 100;
    var x = metric == 'speed' ? preval - val : val - preval;
    if (x < 0) x = -1.0 * x;
    tmp_list.push(x);
    tot += x;
  }
...
function updateFACChart() {
  ...
  if ((0, _keys2.default)(fdata).length > 0) {
    ...
    try {
      for (var _iterator9 = (0, _getIterator3.default)(getFACData(fdata)), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
...
function getFACData(data) {
  ...
  try {
    for (var _iterator10 = (0, _getIterator3.default)(app.checkedScn), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
      var entry = _step10.value;

      var scnkey = FACTXT_MAP_CHK[entry][1];
      var val = data[scnkey][app.selected_metric];
      var preval = data[FACTXT_MAP_CHK[entry][0]][app.selected_metric];
      var x = val - preval;
  ...
  try {
    for (var _iterator11 = (0, _getIterator3.default)(fac_data), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
      var _entry = _step11.value;

      _entry.value = Math.round(_entry.value / tot * 100);
    }
  } catch (err) {
...
function clickScn(scn) {
  ...
  try {
    for (var _iterator13 = (0, _getIterator3.default)((0, _keys2.default)(app.checkedScnFlag)), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
      var s = _step13.value;
