...
// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
__webpack_require__(46)(IteratorPrototype, __webpack_require__(27)('iterator'), function () { return this; });
...
var ctx = __webpack_require__(60);
var invoke = __webpack_require__(409);
...
var _promise = __webpack_require__(402);
...
var isObject = __webpack_require__(51);
var aFunction = __webpack_require__(108);
var anInstance = __webpack_require__(385);
...
if (!USE_NATIVE) {
  ...
  Internal.prototype = __webpack_require__(386)($Promise.prototype, {
    // 25.4.5.3 Promise.prototype.then(onFulfilled, onRejected)
    then: function then(onFulfilled, onRejected) {
      var reaction = newPromiseCapability(speciesConstructor(this, $Promise));
      reaction.ok = typeof onFulfilled == 'function' ? onFulfilled : true;
...
var create = __webpack_require__(164);
var redefineAll = __webpack_require__(386);
var ctx = __webpack_require__(60);
var anInstance = __webpack_require__(385);
var forOf = __webpack_require__(158);
...
var validate = __webpack_require__(401);
var SIZE = DESCRIPTORS ? '_s' : 'size';
...
// https://github.com/DavidBruant/Map-Set.prototype.toJSON
var classof = __webpack_require__(121);
var from = __webpack_require__(418);
module.exports = function (NAME) {
  return function toJSON() {
    if (classof(this) != NAME) throw TypeError(NAME + "#toJSON isn't generic");
    return from(this);
...
// 23.2 Set Objects
module.exports = __webpack_require__(424)(SET, function (get) {
  return function Set() { return get(this, arguments.length > 0 ? arguments[0] : undefined); };
}, {
  // 23.2.3.1 Set.prototype.add(value)
  add: function add(value) {
...
module.exports = __webpack_require__(44).Object.values;
...
var getKeys = __webpack_require__(161);
var toIObject = __webpack_require__(77);
var isEnum = __webpack_require__(440).f;
module.exports = function (isEntries) {
  return function (it) {
    var O = toIObject(it);
    var keys = getKeys(O);
...
__webpack_require__(453)('keys', function () {
  return function keys(it) {
    return $keys(toObject(it));
  };
});
...
var _set = __webpack_require__(416);
...
var _regenerator = __webpack_require__(406);

var _regenerator2 = _interopRequireDefault(_regenerator);

var _asyncToGenerator2 = __webpack_require__(403);

var _asyncToGenerator3 = _interopRequireDefault(_asyncToGenerator2);

var _values = __webpack_require__(436);
    ...
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            geo_url = API_SERVER + GEO_VIEW + '?select=tmc,geometry,street,direction,intersec';
            _context2.prev = 1;
            _context2.next = 4;
...
var getMapData = function () {
  var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3() {
    var data_url, resp, jsonData, lookup, fac_lookup, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, entry, key, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, c;

    return _regenerator2.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            data_url = API_SERVER + DATA_VIEW + '?select=*' +
            //',' + app.selected_bwidth + 
          ...
          case 14:
            ...
            _context3.prev = 22;
            for (_iterator3 = (0, _getIterator3.default)(SCN_LIST_SHORT); !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
              c = _step3.value;

              fac_lookup[key][c] = {};
              fac_lookup[key][c]['vmt'] = entry['mod_vmt_' + c];
              fac_lookup[key][c]['vhd'] = entry['mod_vhd_' + c];
              fac_lookup[key][c]['vht'] = entry['mod_vht_' + c];
              fac_lookup[key][c]['speed'] = entry['mod_speed_' + c];
              fac_lookup[key][c]['vol'] = entry['mod_vol_' + c];
              fac_lookup[key][c]['pti80'] = entry['mod_pti80_' + c];
            }
            _context3.next = 30;
            break;
          ...
          case 55:
            return _context3.abrupt('return', [lookup, fac_lookup]);
    ...
    }, _callee3, this, [[12, 43, 47, 55], [22, 26, 30, 38], [31,, 33, 37], [48,, 50, 54]]);
  }));
...
var drawMapFeatures = function () {
  var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4() {
    ...
    var cleanFeatures, sel_metric, base_metric, comp_metric, lookup_list, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, key, feat_entry, _iteratorNormalCompletion6, _didIteratorError6, _iteratorError6, _iterator6, _step6, _c, _iteratorNormalCompletion5, _didIteratorError5, _iteratorError5, _iterator5, _step5, c, map_metric, bwidth_metric, _iteratorNormalCompletion7, _didIteratorError7, _iteratorError7, _iterator7, _step7, feat, _feat_entry, color_func, sel_colorvals2, bp, dist_vals, x, numticks, histogram, mode, custom_bps, i, bw_widths, _iteratorNormalCompletion8, _didIteratorError8, _iteratorError8, _iterator8, _step8, _feat, _iteratorNormalCompletion9, _didIteratorError9, _iteratorError9, _iterator9, _step9, _i;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            ...
            base_scn = SCNTXT_MAP[app.sliderValue[0]];
            comp_scn = SCNTXT_MAP[app.sliderValue[1]];
            base_metric = 'mod_' + sel_metric + '_' + base_scn;
            comp_metric = 'mod_' + sel_metric + '_' + comp_scn;
          ...
          case 14:
            lookup_list = _context4.sent;

            base_lookup = lookup_list[0];
            fac_lookup = lookup_list[1];

            if (metric_sum_map.hasOwnProperty(app.selected_timep)) {
              _context4.next = 82;
              break;
            }

            metric_sum_map[app.selected_timep] = {};
            _iteratorNormalCompletion4 = true;
            _didIteratorError4 = false;
            _iteratorError4 = undefined;
            _context4.prev = 22;
            _iterator4 = (0, _getIterator3.default)((0, _keys2.default)(base_lookup));
          ...
          case 24:
            ...
            key = _step4.value;
            feat_entry = base_lookup[key];
            _iteratorNormalCompletion6 = true;
            _didIteratorError6 = false;
            _iteratorError6 = undefined;
            _context4.prev = 30;

            for (_iterator6 = (0, _getIterator3.default)(SCN_LIST_SHORT); !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
              _c = _step6.value;

              if (metric_sum_map[app.selected_timep].hasOwnProperty(_c)) {
                metric_sum_map[app.selected_timep][_c]['vmt'] += feat_entry['mod_vmt_' + _c];
                metric_sum_map[app.selected_timep][_c]['vhd'] += feat_entry['mod_vhd_' + _c];
                metric_sum_map[app.selected_timep][_c]['vht'] += feat_entry['mod_vht_' + _c];
                metric_sum_map[app.selected_timep][_c]['voldist'] += feat_entry['mod_vol_' + _c] * feat_entry['distance'];
                metric_sum_map[app.selected_timep][_c]['pti80vmt'] += feat_entry['mod_pti80_' + _c] * feat_entry['mod_vmt_' + _c];
                metric_sum_map[app.selected_timep][_c]['dist'] += feat_entry['distance'];
              } else {
                metric_sum_map[app.selected_timep][_c] = {};
                metric_sum_map[app.selected_timep][_c]['vmt'] = feat_entry['mod_vmt_' + _c];
                metric_sum_map[app.selected_timep][_c]['vhd'] = feat_entry['mod_vhd_' + _c];
                metric_sum_map[app.selected_timep][_c]['vht'] = feat_entry['mod_vht_' + _c];
                metric_sum_map[app.selected_timep][_c]['voldist'] = feat_entry['mod_vol_' + _c] * feat_entry['distance'];
          ...
          case 63:
            ...
            for (_iterator5 = (0, _getIterator3.default)(SCN_LIST_SHORT); !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
              c = _step5.value;

              metric_sum_map[app.selected_timep][c]['vol'] = metric_sum_map[app.selected_timep][c]['voldist'] / metric_sum_map[app.selected_timep][c]['dist'];
              metric_sum_map[app.selected_timep][c]['pti80'] = metric_sum_map[app.selected_timep][c]['pti80vmt'] / metric_sum_map[app.selected_timep][c]['vmt'];
              metric_sum_map[app.selected_timep][c]['speed'] = metric_sum_map[app.selected_timep][c]['vmt'] / metric_sum_map[app.selected_timep][c]['vht'];
            }
            _context4.next = 74;
            break;
          ...
          case 82:
            ...
            _context4.prev = 89;
            for (_iterator7 = (0, _getIterator3.default)(cleanFeatures); !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
              feat = _step7.value;
              ...
              if (app.comp_check) {
                if (base_lookup.hasOwnProperty(feat.tmc)) {
                  _feat_entry = base_lookup[feat.tmc];

                  map_metric = _feat_entry[comp_metric] - _feat_entry[base_metric];
                  feat['base'] = _feat_entry[base_metric];
                  feat['comp'] = _feat_entry[comp_metric];
                  if (app.pct_check && app.comp_check) {
                    if (_feat_entry[base_metric] > 0) {
                      map_metric = map_metric * 100 / _feat_entry[base_metric];
                    }
                  }
                }
              } else {
                if (base_lookup.hasOwnProperty(feat.tmc)) {
                  map_metric = base_lookup[feat.tmc][base_metric];
                }
              }
              if (map_metric !== null) {
          ...
          case 107:
            ...
            if (queryMapData) {
              ...
              if (sel_colorvals.length <= DISCRETE_VAR_LIMIT || INT_COLS.includes(sel_metric)) {
                ...
                if (CUSTOM_BP_DICT.hasOwnProperty(sel_metric)) {
                  custom_bps = CUSTOM_BP_DICT[sel_metric][mode][app.selected_timep];
                  ...
                  sel_colorvals = getQuantiles(map_vals, 5);
                }
            ...
            _context4.prev = 118;
            _iterator8 = (0, _getIterator3.default)(cleanFeatures);
          ...
          case 155:
            ...
            _context4.prev = 159;
            for (_iterator9 = (0, _getIterator3.default)(sel_colorvals2); !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
              _i = _step9.value;
          ...
          case 163:
            _context4.prev = 163;
            _context4.t5 = _context4['catch'](159);
            _didIteratorError9 = true;
            _iteratorError9 = _context4.t5;
          ...
          case 175:
            ...
            mapLegend.onAdd = function (map) {
              ...
              legHTML = '<h4>' + sel_metric.toUpperCase() + (app.pct_check ? ' PCT_DIFF' : METRIC_UNITS.hasOwnProperty(sel_metric) ? ' (' + METRIC_UNITS[sel_metric] + ')' : '') + '</h4>' + legHTML;
              if (app.bwidth_check) {
            ...
            return _context4.abrupt('return', cleanFeatures.filter(function (entry) {
              return entry.tmc == selectedGeo.feature.tmc;
            })[0]);
          ...
          case 191:
            _context4.prev = 191;
            _context4.t6 = _context4['catch'](9);
    ...
    }, _callee4, this, [[9, 191], [22, 51, 55, 63], [30, 34, 38, 46], [39,, 41, 45], [56,, 58, 62], [66, 70, 74, 82], [75,, 77, 81], [89, 93, 97, 105], [98,, 100, 104], [118, 143, 147, 155], [148,, 150, 154], [159, 163, 167, 175], [168,, 170, 174]]);
  }));
    ...
    return _regenerator2.default.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            app.selected_metric == 'speed' ? app.selected_colorscheme = ['#e31a1c', '#fc852f', '#fec44f', '#ffffbf', '#abdda4'] : app.selected_colorscheme = ['#abdda4', '#ffffbf', '#fec44f', '#fc852f', '#e31a1c'];
            _context5.next = 3;
            return drawMapFeatures();
...
var _vueSliderComponent = __webpack_require__(387);

var _vueSliderComponent2 = _interopRequireDefault(_vueSliderComponent);

var _jsCookie = __webpack_require__(397);
...
var DATA_VIEW = 'tmcmod';

var FRAC_COLS = ['speed', 'pti80'];
var INT_COLS = ['dt', 'at', 'ft2'];
var SCNTXT_MAP = { '2010 Base': '2010',
  '2016 Network Effect': 'netchg',
  '2016 Population Effect': 'popchg',
  '2016 Employment Effect': 'empchg',
  '2016 TNC Volume Effect': 'tvolchg',
  '2016 TNC PUDO Effect': 'pudochg' };
var SCN_LIST = (0, _keys2.default)(SCNTXT_MAP);
var SCN_LIST_SHORT = (0, _values2.default)(SCNTXT_MAP);
var FACTXT_MAP = { 'netchg': 'Network',
  'popchg': 'Population',
  'empchg': 'Employment',
  'tvolchg': 'TNC Volume',
  'pudochg': 'PUDO Effect' };

var VIZ_LIST = ['speed', 'vhd', 'vmt', 'pti80', 'vol', 'vht'];
var VIZ_INFO = {
  speed: {
    TXT: 'Speed',
  ...
  vht: {
    TXT: 'Vehicle Hours Traveled (VHT)',
    VIEW: 'cmp_autotransit',
    METRIC: 'atspd_ratio',
    METRIC_DESC: 'Auto/Transit Speed',
    CHARTINFO: 'AUTO/TRANSIT SPEED TREND:',
...
var CUSTOM_BP_DICT = {
  'speed': { 'pctdiff': { 'Daily': [-4, -2, -0.5, 0.5],
      'AM': [-4, -2, -0.5, 0.5],
      'PM': [-4, -2, -0.5, 0.5],
      'MD': [-4, -2, -0.5, 0.5],
      'EV': [-4, -2, -0.5, 0.5],
      'EA': [-4, -2, -0.5, 0.5] } },
  'vhd': { 'pctdiff': { 'Daily': [-5, 5, 20, 35],
      'AM': [-5, 5, 20, 35],
      'PM': [-5, 5, 20, 35],
      'MD': [-5, 5, 20, 35],
      'EV': [-5, 5, 20, 35],
      'EA': [-5, 5, 20, 35] } },
  'vmt': { 'pctdiff': { 'Daily': [-5, 5, 20, 35],
      'AM': [-5, 5, 20, 35],
      'PM': [-5, 5, 20, 35],
      'MD': [-5, 5, 20, 35],
      'EV': [-5, 5, 20, 35],
      'EA': [-5, 5, 20, 35] } },
  'vol': { 'pctdiff': { 'Daily': [-5, 5, 20, 35],
      'AM': [-5, 5, 20, 35],
      'PM': [-5, 5, 20, 35],
      'MD': [-5, 5, 20, 35],
      'EV': [-5, 5, 20, 35],
      'EA': [-5, 5, 20, 35] } },
  'vht': { 'pctdiff': { 'Daily': [-5, 5, 20, 35],
      'AM': [-5, 5, 20, 35],
      'PM': [-5, 5, 20, 35],
      'MD': [-5, 5, 20, 35],
      'EV': [-5, 5, 20, 35],
      'EA': [-5, 5, 20, 35] } },
  'pti80': { 'pctdiff': { 'Daily': [0, 1, 2, 5],
      'AM': [0, 1, 2, 3],
      'PM': [0, 1, 2, 3],
      'MD': [0, 1, 2, 3],
      'EV': [0, 1, 2, 3],
...
var bwidth_metric_list = ['vol', 'vmt'];
var geoLayer = void 0,
    mapLegend = void 0;
...
function getInfoHtml(geo) {
  ...
  return '<b>TMC ID: </b>' + (geo.tmc + '<br/>') + '<b>STREET: </b>' + (geo.street + '<br/>') + '<b>DIRECTION: </b>' + (geo.direction + '<br/>') + '<b>INTERSECTION: </b>' + (geo.intersec + '<br/><hr>') + ('<b>' + app.sliderValue[0] + '</b> ') + ('<b>' + app.selected_metric.toUpperCase() + ': </b>') + (base_val + '<br/>') + ('<b>' + app.sliderValue[1] + '</b> ') + ('<b>' + app.selected_metric.toUpperCase() + ': </b>') + (comp_val + '<br/>') + ('<b>' + app.selected_metric.toUpperCase() + '</b>') + (app.pct_check ? '<b> PCT_DIFF: </b>' : '<b>: </b>') + ('' + metric_val) + (app.pct_check && app.comp_check && metric_val !== null ? '%' : '') + (app.bwidth_check ? '<br/><b>' + app.selected_bwidth.toUpperCase() + '</b>' + '<b>: </b>' + bwmetric_val : '');
}
...
function updateDistChart(bins) {
  ...
  try {
    for (var _iterator10 = (0, _getIterator3.default)(bins), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
      var b = _step10.value;
...
function updateFACChart() {
  ...
  if ((0, _keys2.default)(fdata).length == 0) {
    facChart.setData(fdata);
    return;
  }
  ...
  try {
    for (var _iterator11 = (0, _getIterator3.default)((0, _keys2.default)(SCNTXT_MAP)), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
      var key = _step11.value;

      if (SCNTXT_MAP[key] == base_scn) base_found = true;
      if (SCNTXT_MAP[key] == comp_scn) comp_found = true;
      if (base_found) tmp_data[SCNTXT_MAP[key]] = fdata[SCNTXT_MAP[key]];
      if (comp_found) {
        tmp_data[SCNTXT_MAP[key]] = fdata[SCNTXT_MAP[key]];
        break;
      }
    }
  } catch (err) {
  ...
  var data = getFACData(tmp_data);
  if (facChart) {
    facChart.setData(data);
  } else {
    facChart = new Morris.Donut({
      // ID of the element in which to draw the chart.
      element: 'fac-chart',
      data: data,
      formatter: function formatter(y, x) {
        return y + '%';
      },
      labelColor: '#fff',
      //colors: ['#ff7f00','#984ea3','#4daf4a','#377eb8','#e41a1c'],
      colors: ['#fb8072', '#386cb0', '#7fc97f', '#beaed4', '#fdc086']
    });
  }
}
...
function getFACData(data) {
  var fac_data = [];
  var colors = [];
  var scn_keys = (0, _keys2.default)(data);
  var tot = 0;
  for (var i = 1; i < scn_keys.length; i++) {
    var val = data[scn_keys[i]][app.selected_metric];
    var preval = data[scn_keys[i - 1]][app.selected_metric];
    var x = val - preval;
    if (app.selected_metric == 'speed') x = -1.0 * x;
    if (x < 0) x = 0;
    fac_data.push({ label: FACTXT_MAP[scn_keys[i]], value: x });
    tot += x;
  }
  ...
  try {
    for (var _iterator12 = (0, _getIterator3.default)(fac_data), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
...
var scnSlider = {
  ...
  labelStyle: { color: "#ccc", marginLeft: '6px' },
  piecewiseStyle: { backgroundColor: '#ccc', width: '9.5px', height: '9.5px', visibility: 'visible' }
};
...
var app = new Vue({
  ...
  data: {
    ...
    tplist: ['Daily', 'AM', 'PM', 'MD', 'EV', 'EA'],
    time_options: [{ text: 'Daily', value: 'Daily' }, { text: 'AM', value: 'AM' }, { text: 'PM', value: 'PM' }, { text: 'MD', value: 'MD' }, { text: 'EV', value: 'EV' }, { text: 'EA', value: 'EA' }],

    selected_metric: 'speed',
    metric_options: [{ text: 'Speed', value: 'speed' }, { text: 'Vehicle Hours of Delay', value: 'vhd' }, { text: 'Vehicle Miles Traveled', value: 'vmt' }, { text: 'Volume (Veh/Hr)', value: 'vol' }, { text: 'Vehicle Hours Traveled', value: 'vht' }, { text: 'Planning Time Index', value: 'pti80' }],
    ...
    selected_colorscheme: ['#e31a1c', '#fc852f', '#fec44f', '#ffffbf', '#abdda4'],
    color_options: [{ text: 'Cream-Purple', value: ['#ffffcc', '#3f324f'] }, { text: 'Purple-Cream', value: ['#3f324f', '#ffffcc'] }, { text: 'GnYlRd', value: ['Green', 'Yellow', 'Red'] }, { text: 'RdYlGn', value: ['Red', 'Yellow', 'Green'] }, { text: 'YlOrRd', value: 'YlOrRd' }, { text: 'Yellow-Blue', value: ['#fafa6e', '#2A4858'] }, { text: 'YlRdBl', value: ['Yellow', 'Red', 'Black'] }, { text: 'Spectral', value: 'Spectral' }, { text: 'YlGn', value: 'YlGn' }],
    modeMap: {
      '#ffffcc,#663399': 'lch',
      '#ebbe5e,#3f324f': 'hsl',
      '#ffffcc,#3f324f': 'hsl',
